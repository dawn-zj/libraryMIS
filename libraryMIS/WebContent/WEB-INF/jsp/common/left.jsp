...
<%@ include file="taglibs.jsp"%>
	<div class="menu_dropdown bk_2">
						...
						<ul>
							<c:forEach items="${menuList }" var="menu2">
								<c:if test="${menu2.pid == menu1.id }">
									<li><a data-href="${ctx }${menu2.url }" data-title="${menu2.name }" href="javascript:void(0)">${menu2.name }</a></li>
								</c:if>
							</c:forEach>
						</ul>
					</dd>
		...
		<!-- <dl id="menu-article">
			...
			<dd>
				<ul>
					<li><a data-href="${ctx }/book/bookList.do" data-title="图书管理" href="javascript:void(0)">图书管理</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-article">
